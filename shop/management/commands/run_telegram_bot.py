...
import telebot
from shop.models import Ernar

bot = telebot.TeleBot("6912918273:AAFkLiXYOqfQQB_XOJ2l1qJJZLSVHsCzDHA")  # Замените "TOKEN" на свой токен
...
def add_product(message):
    ...
    # Создаем новый товар
    Ernar.objects.create(name=product_name, price=product_price)
